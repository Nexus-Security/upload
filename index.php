...
<body>
    ...
    <h2>PHP Upload Limits</h2>
    <p>Maximum Upload File Size: <?php echo htmlspecialchars($upload_max_filesize); ?></p>
    <p>Maximum Post Size: <?php echo htmlspecialchars($post_max_size); ?></p>
